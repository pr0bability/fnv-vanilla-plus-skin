...
#define IS_NODE(object) ((*(uint32_t**)object)[3 * 4 >> 2] == 0x6815C0)
#define IS_FADENODE(object) ((*(uint32_t**)object)[4 * 4 >> 2] == 0x6815C0)
#define IS_MULTIBOUNDNODE(object) ((*(uint32_t**)object)[5 * 4 >> 2] == 0x6815C0)
#define IS_GEOMETRY(object) ((*(uint32_t**)object)[6 * 4 >> 2] == 0xE68810)
#define IS_TRIGEOMETRY(object) ((*(uint32_t**)object)[7 * 4 >> 2] == 0xE68810)
#define IS_TRISTRIPS(object) ((*(uint32_t**)object)[8 * 4 >> 2] == 0xE68810)
#define IS_TRISHAPE(object) ((*(uint32_t**)object)[9 * 4 >> 2] == 0xE68810)
#define IS_SEGMENTEDTRISHAPE(object) ((*(uint32_t**)object)[10 * 4 >> 2] == 0xE68810)
#define IS_RESIZABLETRISHAPE(object) ((*(uint32_t**)object)[11 * 4 >> 2] == 0xE68810)
#define IS_PARTICLE(object) ((*(uint32_t**)object)[12 * 4 >> 2] == 0xE68810)
#define IS_LINE(object) ((*(uint32_t**)object)[13 * 4 >> 2] == 0xE68810)
#define IS_NICOLLISION(object) ((*(uint32_t**)object)[14 * 4 >> 2] == 0x6815C0)
#define IS_BLENDCOLLISION(object) ((*(uint32_t**)object)[15 * 4 >> 2] == 0xE68810)
#define IS_RIGIDBODY(object) ((*(uint32_t**)object)[16 * 4 >> 2] == 0x6815C0)
#define IS_HINGECONSTRAINT(object) ((*(uint32_t**)object)[17 * 4 >> 2] == 0xE68810)
#define IS_CONTROLLERMANAGER(object) ((*(uint32_t**)object)[34 * 4 >> 2] == 0xE68810)