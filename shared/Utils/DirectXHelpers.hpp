...
namespace DirectX {
	...
	inline XMMATRIX XM_CALLCONV XMLoadNiMatrix3(const NiMatrix3& arSource) noexcept {
		return XMLoadFloat3x3(reinterpret_cast<const XMFLOAT3X3*>(&arSource));
	}

	inline void XM_CALLCONV XMStoreNiMatrix3(NiMatrix3& arDest, const XMMATRIX& arSource) noexcept {
